	...
	public class EventsHandler implements RfidEventsListener {
		...
		public void eventStatusNotify(RfidStatusEvents rse) {
			...
			if (statusType == STATUS_EVENT_TYPE.INVENTORY_START_EVENT) {
				...
				/*
				if (rse.StatusEventData.DisconnectionEventData.getDisconnectionEvent()
						.eventInfo == DISCONNECTION_EVENT_TYPE.READER_INITIATED_DISCONNECTION)
					...
					*/
						...
						disconnectionEventData="NDZL_Desconnection";
